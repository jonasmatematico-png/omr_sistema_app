...
// Importa a tela do assistente que está na mesma pasta
...
class _TelaCadastroAvaliacaoAbertaState
  ...
  // Variável para guardar o ID da avaliação após salvar
  ...
  // ==========================================================
  // 🚨 MÉTODO SALVAR ATUALIZADO (NÃO FECHA A TELA)
  // ==========================================================
  Future<void> _salvar() async {
    ...
    try {
      ...
      // ✨ MÁGICA AQUI: Guardamos o ID na memória, mas NÃO fechamos a tela!
      setState(() {
        _idAvaliacaoSalva = idAval;
      });
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text(
              '✅ Prova salva com sucesso! Agora você pode usar o Assistente de IA.',
            ),
            backgroundColor: Colors.green,
            duration: Duration(seconds: 3),
          ),
        );
        // REMOVIDO: Navigator.pop(context, true); <-- Era isso que fechava a tela!
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
  ...
  // ==========================================================
  // 🤖 FUNÇÃO PARA ABRIR O ASSISTENTE DE IA
  // ==========================================================
  void _abrirAssistenteIA() {
    if (_idAvaliacaoSalva == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(
          content: Text('⚠️ Salve a prova primeiro para usar o Assistente!'),
          backgroundColor: Colors.orange,
        ),
      );
      return;
    ...
    Navigator.push(
      ...
      if (valorRetornado == true) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('✅ Questões da IA carregadas com sucesso!'),
            backgroundColor: Colors.green,
          ),
        );
      }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // ==========================================================
            // 🤖 BOTÃO DO ASSISTENTE DE IA (SÓ FUNCIONA DEPOIS DE SALVAR)
            // ==========================================================
            SizedBox(
              width: double.infinity,
              child: ElevatedButton.icon(
                onPressed: _abrirAssistenteIA,
                icon: const Icon(Icons.smart_toy, color: Colors.white),
                label: const Text(
                  '🤖 ASSISTENTE DE IA: GERAR/IDENTIFICAR QUESTÕES',
            ...
            // Botão opcional para sair de verdade quando terminar tudo
            SizedBox(
              width: double.infinity,
